        ...
        <div className='loginField'>
          <TextField
            ...
            InputProps={{
              ...
              endAdornment: <InputAdornment position="end"><div onClick={getAuth}>Get OTP</div></InputAdornment>,
          ...
          <TextField
            ...
            type="password"
            variant="outlined"
            InputProps={{ style: { borderRadius: "25px", backgroundColor: '#D3D3D3', fontFamily: "Inter" } }}
            focused
          />
        </div>
