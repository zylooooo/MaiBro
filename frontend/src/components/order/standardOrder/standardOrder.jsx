                ...
                <form>
                    ...
                    <div className='userLocation'>
                        <TextField
                            ...
                            variant='outlined'
                            InputProps={{
                                style: { borderRadius: '25px', backgroundColor: '#D3D3D3', fontFamily: 'Inter' },
                            }}
                            focused
                        />
                        <Button
                            ...
                            fullWidth
                            variant='contained'
                            onClick={() => confirmOrderButton(latitude, longitude, restaurantName, itemQuantity, userLocation)}
                            style={{
                                borderRadius: '25px',
                                fontSize: '0.8em',
                                marginTop: '15px',
            ...
            <div className='main'>
                ...
                <div className='userLocation'>
                    ...
                    <Button
                        ...
                        fullWidth
                        variant='contained'
                        onClick={() => confirmOrderButton(latitude, longitude, restaurantName, order, userLocation)}
                        style={{
                            borderRadius: '25px',
                            fontSize: '0.8em',
                            marginTop: '15px',
