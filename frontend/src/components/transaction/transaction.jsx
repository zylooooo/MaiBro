...
export function Transaction() {
  ...
  useEffect(() => {
    ...
    // Create an async function to get the transaction history from the backend
    async function getTransactionHistory() {
      ...
      await historyList(body).then((response) => {
        ...
        // else set the transaction state
      });
    }
    ...
    <>
      ...
      <div className="historyList">
        {data.map(function (individualdata, index) {
          ...
          if (
            individualdata.orderAccepted == false ||
            individualdata.orderCollected == false ||
            individualdata.orderCompleted == false
          ) {
            completedOrPending = (
